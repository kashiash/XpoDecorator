...
using XpoDecorator.Blazor.Server.Services;

namespace XpoDecorator.Blazor.Server {
    public partial class XpoDecoratorBlazorApplication : BlazorApplication {
        public XpoDecoratorBlazorApplication() {
            InitializeComponent();
        }
        ...
        private void XpoDecoratorBlazorApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
